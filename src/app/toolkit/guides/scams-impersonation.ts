...
export const scamsImpersonationGuides: Guide[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        answer:
          "For impersonation claims, Instagram asks for a government ID photo to confirm you're the real person being copied. It's a standard verification step and a legitimate part of the takedown process. Submitting it speeds removal, because Instagram can't act on “that's not me” without confirming who you actually are.",
      },
      {
        id: "warn-followers",
        question: "How do I protect my followers while the clone is up?",
        answer:
          "Post a story and a pinned note telling followers about the fake account, what your only real handle is, and that you'll never DM them asking for money, gift cards, or login links. Most impersonator damage comes from scam DMs to your audience, so a quick warning cuts off the scam before takedown completes.",
      },
      {
